...
export namespace Attivita {
    ...
    export class Attivita {//l'oggetto è preso con la chiamata get chiusura attività potrebbe essere diverso da quello che ricevo con la chiamata gel_elenco_attivita
