...
export class ComunicazioniService {
    ...
    public getListaComunicazioni(serverUrl: string, token: string, sito_key: number, procedimento_key:number): Observable<Http.HttpResponse> {
        return this.httpService.get(serverUrl + GlobalVariable.BASE_API_URL + GlobalVariable.COMUNICAZIONI_GET_ELENCO_KEYWORD
