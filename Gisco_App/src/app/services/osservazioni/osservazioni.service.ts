...
export class OsservazioniService {
    ...
    public getListaOsservazioni(serverUrl: string, token: string, tipo_cod: any, sito_cod: string, prot_cod: string, from: number, to: number, stato: string): Observable<Http.HttpResponse> {
